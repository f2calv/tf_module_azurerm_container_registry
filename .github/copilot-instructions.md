...
This repository publishes a single reusable Terraform child module that provisions an Azure Container Registry for storing container images and Helm charts.
