...
- Commit the generated README output with the Terraform interface change that produced it.
- Enforce terraform-docs drift through both pre-commit and CI so stale generated documentation fails validation.
